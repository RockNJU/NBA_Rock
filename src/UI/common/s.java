...
public class s extends JPanel
{
        ...
        public s(Container owner,int length) {
           this.owner = owner;
        ...
        public s(Container owner, String partten,int length) {
            this.owner = owner;
            this.parten = partten;
            this.length=length;
            try {
        ...
        public s(Container owner, String partten) {
            this.owner = owner;
            this.parten = partten;
            try {
                init();
        ...
        private void init() throws Exception {
            ...
            btnChoose.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    s.this.btnChoose_actionPerformed(e);
                }
            });
            Date date = new Date();
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getButton() == MouseEvent.BUTTON1 && e.getClickCount() == 1) {
                    ...
                    SimpleDateFormat simpleDateFormat = new SimpleDateFormat(
                        pattern);
                    s.this.setText(simpleDateFormat.format(selectDate));
